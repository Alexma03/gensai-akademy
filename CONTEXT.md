...
_Avoid_: abrir un ventanal garantizado, dar sentido a la vida como promesa comercial

**Promesa paraguas**:
`Comprender cómo piensas, sientes y desarrollas tu talento para avanzar con mayor claridad`; conecta los recorridos sin sustituir la promesa específica de cada oferta.
...
**Coach**:
Rol profesional que formará parte del posicionamiento de Mary. La certificación futura en Coaching Puro y Coaching Estratégico no se presentará como obtenida hasta completar y verificar la titulación.
_Avoid_: psicóloga, coach certificada antes de obtener el título
...
**Blog**:
Sección editorial única donde Mary responde búsquedas informativas sobre orientación vocacional, Geniotipo y altas capacidades y conduce cada artículo hacia un único recorrido relacionado.
_Avoid_: Recursos, tres blogs separados, artículos creados solo para acumular keywords
...
**Embudo AACC adultos**:
Recorrido de captación para adultos con altas capacidades que buscan claridad, propósito y decisiones prácticas mediante coaching y educación emocional.
_Avoid_: diagnóstico de altas capacidades, tratamiento emocional
...
**Familia AACC**:
Familia que busca orientación y herramientas para acompañar a un hijo con una identificación oficial previa de altas capacidades.
_Avoid_: familia en fase de sospecha, paciente infantil

## Servicio

**Acompañamiento**:
Proceso educativo o de coaching orientado a autoconocimiento, decisiones y herramientas prácticas, sin diagnóstico ni tratamiento clínico.
...
**Acompañamiento emocional para menores con altas capacidades**:
Sesiones individuales online de 60 minutos, sueltas o agrupadas en paquetes, para que un menor ya identificado aprenda a reconocer, comprender y comunicar mejor sus emociones; puede incluir actividades breves entre sesiones y termina con un cierre conjunto con los tutores.
_Avoid_: terapia infantil, tratamiento emocional, evaluación psicológica, informe clínico

**Sesión inicial AACC para adultos**:
Primera sesión individual online de 60 minutos para una persona con identificación oficial previa, orientada a comprender su situación, concretar un objetivo y decidir si necesita continuidad.
_Avoid_: evaluación de altas capacidades, diagnóstico, sesión terapéutica

**Acompañamiento AACC para adultos**:
Sesiones individuales online de 60 minutos, sueltas o agrupadas en paquetes, que conectan autoconocimiento y educación emocional con claridad, decisiones y acción; pueden incluir ejercicios entre sesiones y construyen un plan personal de próximos pasos.
_Avoid_: terapia, tratamiento, recuperación emocional garantizada, coaching para personas sin identificación oficial

**Participación tutelada**:
Modelo en el que los tutores contratan, autorizan y participan al inicio y al cierre; el menor acepta participar y puede trabajar individualmente en partes intermedias.
_Avoid_: contratación del menor, intervención sin consentimiento

**Límite de seguridad**:
Exclusión o interrupción del acompañamiento cuando aparecen necesidades clínicas, indicando que corresponde acudir a un profesional sanitario cualificado.
...
_Avoid_: experiencia equivalente, especialidad no acreditada

**Reseña**:
Testimonio real publicado con permiso después de prestar un servicio; no existe como prueba disponible para el lanzamiento inicial.
_Avoid_: testimonio de ejemplo, caso inventado
